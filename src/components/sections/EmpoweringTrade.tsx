        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-[50px] items-center">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="rounded-2xl sm:rounded-3xl overflow-hidden bg-zarea-secondary h-[250px] sm:h-auto sm:order-1 order-2">
                <Image src={"/images/ceo.jpg"} alt="Empowering Trade" width={500} height={600} className="object-cover w-full h-full" />
              </div>
              <div className="rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 overflow-hidden bg-zarea-accent-orange text-white flex flex-col min-h-[250px] sm:order-2 order-1">
